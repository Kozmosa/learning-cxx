...
// This function is not a pure function, since the array cache is a static variable, which is changeable in the function process.
...
static unsigned long long fibonacci(int i) {
    ...
    // TODO: 设置正确的循环条件
    for (cached = 2; cached <= 96 && cached <= i; ++cached) {
